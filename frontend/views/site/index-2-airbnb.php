	...
	<div class="row">
		...
		<div class="col-md-12">
			<h3 class="headline centered margin-bottom-35 margin-top-70">
				...
				<span>Top Destinations to Visit in 2019</span></h3>
		</div>
		
		<div class="col-md-6">

			<!-- Image Box -->
			<a href="listings-list-with-sidebar.html" class="img-box alternative-imagebox" data-background-image="images/popular-location-01.jpg">
		...
		<div class="col-md-6">
			...
			<!-- Image Box -->
			<a href="listings-list-with-sidebar.html" class="img-box alternative-imagebox" data-background-image="images/popular-location-02.jpg">
				<div class="img-box-content visible">
					<h4>Los Angeles</h4>
		...
		<div class="col-md-4">
			<!-- Image Box -->
			<a href="listings-list-with-sidebar.html" class="img-box alternative-imagebox" data-background-image="images/popular-location-03.jpg">
				<div class="img-box-content visible">
					<h4>San Francisco </h4>
		...
		<div class="col-md-4">
			<!-- Image Box -->
			<a href="listings-list-with-sidebar.html" class="img-box alternative-imagebox" data-background-image="images/popular-location-04.jpg">
				<div class="img-box-content visible">
					<h4>Miami</h4>
		...
		<div class="col-md-4">
			<!-- Image Box -->
			<a href="listings-list-with-sidebar.html" class="img-box alternative-imagebox" data-background-image="images/popular-location-05.jpg">
				<div class="img-box-content visible">
					<h4>Chicago</h4>
...
<!-- Flip banner -->
<a href="listings-half-screen-map-list.html" class="flip-banner parallax" data-background="images/slider-bg-02.jpg" data-color="#f91942" data-color-opacity="0.85" data-img-width="2500" data-img-height="1666">
	<div class="flip-banner-content">
		<h2 class="flip-visible">Explore top-rated attractions nearby</h2>
