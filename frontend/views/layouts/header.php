	...
	<div id="header">
		<div class="container">
			...
			<div class="left-side">
				...
				<!-- Logo -->
				<div id="logo">
					<a href="index.html"><img src="<?= Yii::$app->request->baseUrl;?>/frontend/assets/images/logo2.png" data-sticky-logo="<?= Yii::$app->request->baseUrl;?>/frontend/assets/images/logo.png" alt=""></a>
				</div>
			...
			<div class="right-side">
				<div class="header-widget">
					<!-- User Menu -->
					<div class="user-menu">
						<div class="user-name"><span><img src="<?= Yii::$app->request->baseUrl;?>/frontend/assets/images/dashboard-avatar.jpg" alt=""></span>Hi, Tom!</div>
						<ul>
