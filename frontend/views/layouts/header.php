	...
	<div id="header">
		<div class="container">
			...
			<div class="left-side">
				...
				<!-- Logo -->
				<div id="logo">
					<a href="<?= Url::to(['site/index'])?>"><img src="<?= Yii::$app->request->baseUrl;?>/images/logo2.png" data-sticky-logo="<?= Yii::$app->request->baseUrl;?>/images/logo.png" alt=""></a>
				</div>
				...
				<nav id="navigation" class="style-1">
					<ul id="responsive">
						...
						<li><a class="current" href="#">Home</a>
							<ul>
								<li><a href="<?= Url::to(['site/index'])?>">Home 1</a></li>
								<li><a href="<?= Url::to(['site/airbnb'])?>">Home 2 (Airbnb)</a></li>
								<li><a href="<?= Url::to(['site/index3'])?>">Home 3</a></li>
								<li><a href="<?= Url::to(['site/index4'])?>">Home 4</a></li>
								<li><a href="<?= Url::to(['site/index5'])?>">Home 5</a></li>
								<li><a href="<?= Url::to(['site/index6'])?>">Home 6</a></li>
							</ul>
						</li>
						...
						<li><a href="#">Listings</a>
							<ul>
								<li><a href="#">List Layout</a>
									<ul>
										<li><a href="<?= Url::to(['listings/list-sidebar'])?>">With Sidebar</a></li>
										<li><a href="<?= Url::to(['listings/list-fullwidth'])?>">Full Width</a></li>
										<li><a href="<?= Url::to(['listings/list-fullwidth-map'])?>">Full Width + Map</a></li>
									</ul>
								</li>
						...
						<li><a href="#">User Panel</a>
							<ul>
								<li><a href="<?= Url::to(['dashboard/panel'])?>">Dashboard</a></li>
								<li><a href="<?= Url::to(['dashboard/message'])?>">Messages</a></li>
								<li><a href="<?= Url::to(['dashboard/booking'])?>">Bookings</a></li>
								<li><a href="<?= Url::to(['dashboard/wallet'])?>">Wallet</a></li>
								<li><a href="<?= Url::to(['dashboard/listing'])?>">My Listings</a></li>
								<li><a href="<?= Url::to(['dashboard/review'])?>">Reviews</a></li>
								<li><a href="<?= Url::to(['dashboard/bookmark'])?>">Bookmarks</a></li>
								<li><a href="<?= Url::to(['dashboard/add-listing'])?>">Add Listing</a></li>
								<li><a href="<?= Url::to(['dashboard/profile'])?>">My Profile</a></li>
								<li><a href="<?= Url::to(['dashboard/invoice'])?>">Invoice</a></li>
							</ul>
						</li>
