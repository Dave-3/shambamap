									...
									<li>
										...
										<div class="comment-content"><div class="arrow-comment"></div>
											...
											<div class="review-images mfp-gallery-container">
												<a href="<?= Yii::$app->request->baseUrl ?>/images/review-image-01.jpg" class="mfp-gallery"><img src="<?= Yii::$app->request->baseUrl ?>/images/review-image-01.jpg" alt=""></a>
											</div>
								...
								<ul>
									<li>
										...
										<div class="comment-content"><div class="arrow-comment"></div>
											...
											<div class="review-images mfp-gallery-container">
												<a href="<?= Yii::$app->request->baseUrl ?>/images/review-image-02.jpg" class="mfp-gallery"><img src="<?= Yii::$app->request->baseUrl ?>/images/review-image-02.jpg" alt=""></a>
												<a href="<?= Yii::$app->request->baseUrl ?>/images/review-image-03.jpg" class="mfp-gallery"><img src="<?= Yii::$app->request->baseUrl ?>/images/review-image-03.jpg" alt=""></a>
											</div>
											<a href="#small-dialog" class="rate-review popup-with-zoom-anim"><i class="sl sl-icon-action-undo"></i> Reply to this review</a>
										</div>
									</li>
					...
					<ul>
						...
						<li>
							<div class="comments listing-reviews">
								<ul>
									<li>
										<div class="avatar"><img src="<?= Yii::$app->request->baseUrl ?>/images/reviews-avatar.jpg" alt="" /> </div>
										<div class="comment-content"><div class="arrow-comment"></div>
